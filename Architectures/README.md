...
| Arch 6: (CNN 8 Classes) → (VLM 10 Classes) | Test 3 | 93.20% | 91.60% | 7.95 FPS |
| Arch 7: (CNN 10 Classes) → (VLM 10 Classes) | Test 1 | 97.80%| 93.00% | 6.61 FPS |
| Arch 8: (VLM 10-Class) → (VLM Grading) | Test 4 | 97.90% | 95.70% | 25.95 FPS |
| Arch 9: [CNN 10 Classes + VLM 10 classes] → (VLM Grading) | Test 4 | 98.00% | 96.50% | 6.83 FPS |
